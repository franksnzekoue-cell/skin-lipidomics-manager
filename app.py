...
st.sidebar.page_link("pages/0_Tableau_de_bord.py", label="📊 Tableau de bord (page 0)")
...
st.sidebar.page_link("pages/6_Assistant_IA_scientifique.py", label="🧠 Assistant IA scientifique")
st.sidebar.markdown("---")
